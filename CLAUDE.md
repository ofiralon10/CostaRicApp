...
## Deployed Version
**App version: `0.56`** — Enriched the Madrid days (16–19) with practical `notes`: food picks (San Miguel = grazing not dinner; Cava Baja tapas e.g. Txirimiri/Casa Lucio), getting-around logistics (Teleférico west ↔ Ikono south by metro), El Rastro pickpocket/early-start tip, Bernabéu metro L10 + arrive-early, airport transport (~30–40 min Metro/Cercanías or ~€30 taxi), and heat/AC guidance. Also added round-trip Teleférico advice (v0.55).

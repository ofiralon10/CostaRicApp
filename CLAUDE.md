...
## Deployed Version
**App version: `0.57`** — Added an **Accommodation** (🏨 `accommodation`) category to the Budget tracker's live spend buckets (`CATEGORIES` in `BudgetPage.tsx`); grid/breakdown/list all iterate dynamically so nothing else changed.
